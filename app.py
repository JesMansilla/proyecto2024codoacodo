...
catalogo = Catalogo(host='jesicamansilla.mysql.pythonanywhere-services.com', user='jesicamansilla', password='miDataBase', database='jesicamansilla$LaTr3nza')


RUTA_DESTINO = '/home/jesicamansilla/mysite/static/img/' 
